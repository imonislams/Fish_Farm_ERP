...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['name' => 'grid']));
...
foreach (array_filter((['name' => 'grid']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<svg
    <?php echo e($attributes->merge(['class' => 'h-5 w-5 shrink-0'])); ?>
...
<?php /**PATH C:\xampp\htdocs\Fish-Farm_ERP\resources\views/components/sidebar/icon.blade.php ENDPATH**/ ?>