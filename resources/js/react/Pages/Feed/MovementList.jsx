...
/**
 * FeedMovementList — the shared shell for the three feed movement lists
 * (purchases, usages, adjustments). Same shape as the Fish MovementList.
 */
function FeedMovementList({ config, rows, filters = {}, options = {} }) {
    const { props } = usePage();
    ...
    const exportHref = routes[config.exportRoute]
        ? exportParams
...
export default FeedMovementList;
