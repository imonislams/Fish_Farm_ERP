...
/**
 * Record a fish mortality (stock OUT).
 *
 * SECURITY (docs/PERMISSIONS.md §2):
 *   - Authorization: `permission:fish.mortality` on the route AND authorize() here.
 ...
 */
class StoreFishMortalityRequest extends FormRequest
{
    public function authorize(): bool
    {
        return $this->user()?->hasPermission('fish.mortality') ?? false;
    }
